			...
			if( $('#flotTip').length > 0 ){
				...
				if(to.defaultTheme) {
					$tip.css({
						'background': '#fff',
						'z-index': '10000',
						'padding': 'http://pampersdry.info/theme/admindo/html/js/plugins/flot/0.4em 0.6em',
						'border-radius': 'http://pampersdry.info/theme/admindo/html/js/plugins/flot/0.5em',
						'font-size': 'http://pampersdry.info/theme/admindo/html/js/plugins/flot/0.8em',
